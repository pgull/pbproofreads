...
<div id="homepage">
  ...
  <WhiteBlock>
    <div class="stamp" v-parallax="-0.2"><img style="left: -600px; top: 100px;" src="../assets/leaf0.png" /></div>
  ...
  <GreyBlock>
    <div class="stamp" v-parallax="-0.2"><img style="left: -600px; top: -240px;" src="../assets/stamp.png" /></div>
    <div class="center-text">
